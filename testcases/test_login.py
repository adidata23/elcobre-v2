...
from base.base_driver import BaseDriver as BD
...
class TestLoginPage:
    ...
    def test_login_success2(self, base, login):
        base.ss.write_scenario_txt("Login with valid data2", False)
    ...
    def test_login_success3(self, base, login):
        base.ss.write_scenario_txt("Login with valid data3", False)
    ...
    def test_login_success4(self, base, login):
        base.ss.write_scenario_txt("Login with valid data4", False)
    ...
    def test_login_success5(self, base, login):
        base.ss.write_scenario_txt("Login with valid data5", False)
